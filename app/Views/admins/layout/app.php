    ...
    <div class="wrapper">
        <div class="sidebar" data-background-color="white" data-active-color="danger">
            ...
            <div class="sidebar-wrapper">
                <div class="logo">
                    <a href="/admin/category" class="simple-text">
                        House Care
                    </a>
                </div>

                <ul class="nav">
                    <li class="<?= $uri->getSegment(1, 'admin/dashboard') == 'admin/dashboard' ? 'active' : '' ?>">
                        <a href="/admin/dashboard">
                            <i class="ti-panel"></i>
                            <p>Dashboard</p>
                        </a>
                    </li>
                    <li class="<?= $uri->getSegment(1, 'admin/category') == 'admin/category' ? 'active' : '' ?>">
                        <a href="/admin/category">
                            <i class="ti-user"></i>
                            <p>Category</p>
                        </a>
                    </li>
                    <li class="<?= $uri->getSegment(1, 'admin/location') == 'admin/location' ? 'active' : '' ?>">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown" id="update">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    <i class="ti-bell"></i>
                                    <p class="notification" id="total"></p>
                                    <p>Notifications</p>
                                    <b class="caret"></b>
                                </a>
